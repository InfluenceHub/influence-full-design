...
?>
    ...
    <div class="section-heading">
      <h1><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/myinfluence4.png"></h1><br /><br />
      <div class="line"></div>
    </div><!-- /.section-heading -->
      <?php
        //A-Z Browse
        ...
        <div class="shell browse-az<?php echo $extraclass; ?>">
          ...
          <div class="azSteps">
          <h2>Subscribe to <br />your favorite<br /> influencers</h2>
          <br />
          <div class="azStep">
          ...
          </div><!-- /.section-heading --><br /><br /><br /><br />
          <div class="az-links">
            <ul>
            <?php
