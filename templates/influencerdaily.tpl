        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateColumns">
            <tr>
                <td align="center" valign="top" style="padding-top: 12px;">
                    ...
                    {$inc = 0}
                    {foreach from=$influencers item=influencer}

                    {foreach from=$influencer.posts item=post}
                    {$inc = $inc + 1}
                    {if $inc % 3 == 1}
                    <table border="0" cellpadding="0" cellspacing="0" width="700" class="templateContainer">
                        <tr>
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="false">
                                                            ...
                                                            <tr>
                                                                <td class="mcnTextContent" valign="top" style="padding:5px 0;;" width="224">
                                                                    <h3 style="text-transform: uppercase; text-align: center; color: #555 !important; background-color: #d4fff7; letter-spacing: 1px; font-weight: normal; font-size: 12px; line-height: 12px; margin: 0 0 5px; padding: 5px 5%;" align="center">{$influencer.influencer->post_title}</h3>
                                                                    <a href="{$baseDomain}/dev/{$post->post_name}" style="outline: 0; color: #000; text-decoration: none; cursor: pointer; margin: 0; padding: 0; display: block; width: 224px; height: 357px;">
                                                                        {get_the_post_thumbnail($post->ID, array(224,423))}
                                                                    </a>
                                                                    {if $post->productImages}
                                                                        <table>
                                                                            <tr>
                                                                                <td valign="top" style="padding:5px 0;  border-bottom: 1px solid #b5f4e8; text-align: center;" width="224">
                                                                                    {foreach from=$post->productImages item=productImage}
                                                                                        <a href="{$baseDomain}/dev/{$post->post_name}" style="width: 53px; display: inline-block;" class="product-image">{$productImage}</a>
                                                                                    {/foreach}
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    {/if}
                                                                    <a href="{$baseDomain}/dev/{$post->post_name}" style="text-decoration: none; display: block; text-align: center;"><p style="font-family: Georgia, serif; font-size: 12px;margin-top: 6px; padding-left: 10px; padding-right: 10px; text-align: center; color: #4d4d4d;">{$post->post_title}</p><img src="http://www.theinfluence.com/wp-content/themes/influence-full-design/images/email/shop.gif" align="center" /></a>
                                                                    </a>
                                                                </td>
                                                            </tr>
