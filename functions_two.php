...
$args = array(
 ...
 $link1ID = get_post('item1_link_url'); 
 $link2ID = get_post('item2_link_url'); 
 $link3ID = get_post('item3_link_url'); 
 $link4ID = get_post('item4_link_url'); 
 $link5ID = get_post('item5_link_url'); 
