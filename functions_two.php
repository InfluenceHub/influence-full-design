      ...
      ?>
        <li>
          <div class="image-wrap">
            ...
            <div class='right'>
              <div style="margin-bottom: 20px;"> <img src="<?php echo $side_one ?>" height="130px" width="130px"></div>
              <div style="margin-bottom: 20px;"> <img src="<?php echo $side_two ?>" height="130px" width="130px"></div>
