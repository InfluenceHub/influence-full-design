...
$args = array(
 ...
 $link1 = get_post_meta($postID, 'item1_link_url', true); 
 $link2 = get_post_meta($postID, 'item2_link_url', true); 
 $link3 = get_post_meta($postID, 'item3_link_url', true); 
 $link4 = get_post_meta($postID, 'item4_link_url', true); 
 $link5 = get_post_meta($postID, 'item5_link_url', true); 
