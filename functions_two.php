 ...
 <div class="favorites_center">
  ...
  <div class="favorites" style="border-left: 10px solid #d5f7ec;">
   <a href="<?php echo $link1; ?>">
    ...
    <div class="favorites_hover_container">
      <div class="favorites_hover"><span>SHOP<br />ITEM</span></div>
    </div>
    </a>
  </div>
  <div class="favorites">
...
<!-- 300x600_BCBG -->
<!-- <div id='div-gpt-ad-1411173041444-0' style='width:300px; height:600px;'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1411173041444-0'); });
</script>
</div> -->
<!-- Staging_300x600_ATF -->
<div id='div-gpt-ad-1411688893470-0' style='width:300px; height:600px;'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1411688893470-0'); });
</script>
</div>
...
<!-- Staging_300x600_BTF -->
<div id='div-gpt-ad-1411689469408-0' style='width:300px; height:600px;'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1411689469408-0'); });
</script>
</div>
            <div class="line" style="margin-top: 7px; padding-top: 7px;"></div>
            <?php inf_qa(); ?>
  ...
  function inf_item_of_the_day() {
    ...
    <a href="javascript:void(0)"> 
        <h2>Item of the Day</h2>
            <img src="<?php echo $product_image[0] ?>" width="<?php echo $product_image[1]; ?>" height="<?php echo $product_image[2]; ?>" data-prodid="218574113" data-cid="22" 
alt="Item of the Day" />
