...
function inf_theme_slider_theme() {
  ...
  foreach($images as $image) {
    ...
    <li class="slide-theme">
	  ...
	  <?php if($image['inf_caption2']): ?><div class="slide_text" style="display:none;" id="slide_text_<?php echo $i; ?>"><?php echo $image['inf_caption2'] ?><a href="<?php echo $image['inf_caption_url'] ?>"><?php echo $image['product_url'] ?></a></div><?php endif; ?>
	</li>
     <?php
	 $i++;
    }
