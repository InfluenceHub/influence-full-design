...
?>
  <section id="content">
    ...
    ?>
<!--<div class="in-video"> -->
<div class="in-video" style="margin-top: -25px;">
 <div class="video-row" id="videos">
  <br />
        <div class="section-heading">
          <h2><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/invid.png" /></h2><br /> <br />       </div><!-- /.section-heading -->
...
-->
    ...
    <div class="bottom-section" style="margin-top: -30px;">
      <div class="section-heading">
        <h2><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/unda.png" style="top: -5px;" /></h2>
      </div><!-- /.section-heading -->
      <br />
      <div class="shell" style="margin-top: -3px;">
        <?php
        ...
        if(!empty($pinterest_username)) { ?>
          <div class="column-two">
                  ...
                  <?php 
                    if (count($instagram_data) > 0) {
                      foreach($instagram_data as $index => $id) {
                        $last = ''; if($index == 2) { $last = ' margin-right: 0;'; }
                      ?>
                        <li style="width:160px; <?php echo $last; ?>" class="pins-feed-item">
                          <a href="<?php echo esc_url($id['image_url']); ?>" target="_blank"><div class="nailthumb-container" style="overflow: hidden; padding: 0px; width: 160px; height: 160px;"><img src="<?php echo $id['image_src']; ?>" width="160" height="160" alt="" /></div></a>
                        </li>
                      <?php
                        if($index == 2) {
                          break;
            ...
            <h2 style="clear: both;">NEWSLETTER</h2>
          ...
          <div class="column adcolumn" style="border-left: 1px solid #ccc;">
            ...
            <a href="<?php echo home_url(); ?>/inf-interview/zoey-deutch/"><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/featured-influencer-box.png" width="300" height="415" alt="Featured Influencer" /></a>
...
<div class="ui basic modal">
  ...
  <div class="form-wrapper">
    <form action="http://theinfluence.us8.list-manage.com/subscribe/post?u=527260c47d9de3929c883ec2d&amp;id=69a8f6e293" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="container" target="_blank" novalidate class="container">
        <img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/intro.png" alt="The Influence" />
<br /><br /><br />
